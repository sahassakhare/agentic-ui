...
| [ADR-006 — MCP server-side adapter](./docs/adr/0006-mcp-server-side-adapter.md) | Detailed plan for the next feature: scope, public API, 6-phase implementation, acceptance criteria, alternatives considered. **Status: Proposed.** |
