...
with [\`@infra-tools/agentic-ui\`](https://github.com/sahassakhare/agentic-ui).
...
- [@infra-tools/agentic-ui](https://github.com/sahassakhare/agentic-ui/blob/main/projects/agentic-ui/README.md) — runtime API
 ...
 *
 * See @infra-tools/agentic-ui docs:
