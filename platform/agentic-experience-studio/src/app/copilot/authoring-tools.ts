...
const createDraftCapability = agenticTool({
  ...
  description:
    ...
    + '• datasource → { kind: "rest", description, endpoint: "https://host", method?: GET|POST|PUT|PATCH|DELETE, headers?: { "x-foo": "bar", "authorization": "Bearer ${SECRET_NAME}" } } — a governed HTTP base. Put secrets as ${NAME} references, NEVER literal tokens.\n'
