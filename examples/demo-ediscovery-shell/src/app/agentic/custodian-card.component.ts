 ...
 * returns `components: [{ name: 'custodianCard', props }]`.
 */
@Component({
  ...
  `,
  styles: `
    .card { padding: 0.7rem 0.9rem; border: 1px solid #d1d5db; border-radius: 0.5rem; background: #fff; margin-top: 0.5rem; font: 0.88rem system-ui; border-left: 4px solid #4f46e5; }
